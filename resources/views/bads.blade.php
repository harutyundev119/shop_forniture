            ...
            <div class="widget catagory mb-50">
                ...
                <div class="catagories-menu">
                    <ul>
                        ...
                        <li><a href="shop/bads">Beds</a></li>
                        <li><a href="shop/accesories">Accesories</a></li>
                        <li><a href="shop/furniture">Furniture</a></li>
                        <li><a href="shop/home_deco">Home Deco</a></li>
                        <li><a href="shop/dressings">Dressings</a></li>
                    ...
                    <div class="col-12 col-sm-6 col-md-12 col-xl-6">
                        <div class="single-product-wrapper">
                            ...
                            <div class="product-img">
                                <img src="data:image/png;base64,{{ chunk_split(base64_encode($product->data)) }}" alt="">
                                <!-- Hover Thumb -->
